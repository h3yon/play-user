...
public class JwtUtil {
    ...
    public String createToken(Long userId, String email, String username, Integer role, String tokenType, int minutes) {
    ...
    public Authentication getAuthentication(String token) {
        ...
        return new UsernamePasswordAuthenticationToken(email, null, Collections.singletonList(new SimpleGrantedAuthority((role<50)? "ROLE_USER" : "ROLE_ADMIN")));
    }
